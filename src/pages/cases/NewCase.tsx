...
import Step4Sessions from "../../components/cases/steps/Step4Sessions";
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setData({
        ...
        caseDate: c.caseDate ?? "",
        lawsuitSubject: c.lawsuitSubject ?? "",
        facts: c.facts ?? "",
        claims: c.claims ?? "",
        defenses: c.defenses ?? "",
        legalBasis: c.legalBasis ?? "",
        legalArticles: c.legalArticles ?? "",
        claimValue: c.claimValue ?? 0,
        riskLevel: c.riskLevel ?? 0,
        caseSummary: c.caseSummary ?? "",
        legalStrategy: c.legalStrategy ?? "",
        ...
        sessions: (c.sessions as CaseFormState["sessions"]) ?? [],
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6 items-start">
      <div className="card p-6 space-y-6 order-2 lg:order-1">
        ...
        {current === 3 && <Step4Sessions {...stepProps} />}
